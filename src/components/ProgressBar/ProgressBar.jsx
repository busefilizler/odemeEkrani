...
export default function ProgressBar() {
  ...
  return (
    <div className="flex flex-row justify-between items-center bg-white h-20 border-b-2 border-gray-300 px-40 md:px-40">
      {steps.map((step, index) => (
        <React.Fragment key={index}>
          <div className="flex flex-row gap-1 items-center text-black w-fit">
            <CheckCircleOutlineOutlinedIcon sx={{ color: "red" }} />
