...
const deliveryInfo = {
  shipping: {
    ...
    address: "Açıkköy Mah. Hakkı Sk. Big Tower No: 79-20D Ataşehir, İstanbul, 34560, TR",
    phone: "+90 599 777 56 13",
  },
  billing: {
    title: "Fatura Adresi",
    email: "fatura@durudogan.com",
    address: "Beylikdüzü Mah. Güneş Sk. No: 15 Kat:3 Daire:5, İstanbul, 34520, TR",
      ...
      <div className="flex flex-col gap-6">
        {[deliveryInfo.shipping, deliveryInfo.billing].map((info) => (
          <div key={info.title} className="flex flex-col gap-1 px-3">
            <div className="font-semibold text-sm text-black pb-2">{info.title}</div>
